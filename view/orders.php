...
<body>
    <div class="container">
        ...
        <div class="row align-items-center mt-3 mb-3">
            ...
            <div class="col-md-8 col-12 text-md-right text-center">
                <div class="nav-links mt-md-0 mt-3">
                    ...
                    <a href="admin.php?orders=true" class="active-link">Orders</a>
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <form class="form" action="admin.php" method="POST">
                        <div class="modal-body">            
                            <label>Product id</label>
                            <input class="form-control" value="<?= $selected_row['product_id'] ?>" type="text" name="product_id"><br>

                            <label>Employee id</label>
                            <input class="form-control" value="<?= $selected_row['employee_id'] ?>" type="text" name="employee_id"><br>

                            <label>Customer id</label>
                            <input class="form-control" value="<?= $selected_row['customer_id'] ?>" type="text" name="customer_id"><br>

                            <label>Order date</label>
                            <input class="form-control" value="<?= $selected_row['order_date'] ?>" type="date" name="order_date"><br>
                ...
                <?php foreach ((array)$data as $d) : ?>
                    <tr>
                        <?php foreach ($d as $item) : ?>
                            <td><?= $item; ?></td>
                        <?php endforeach ?>
                        <td><a class="btn btn-warning" <?= $init_modal ?> href="admin.php?orders=true&action=edit&id=<?= $d['id'] ?>"><i class="fas fa-pen"></i></a></td>
                        <td><a class="btn btn-danger" href="admin.php?orders=true&action=delete&id=<?= $d['id'] ?>"><i class="fas fa-trash-alt"></i></a></td>
                    </tr>
                <?php endforeach ?>
            </table>
        </div>
        ...
        <script>
            function closeModal() {
                window.location.replace("/zoo/core/admin.php?orders=true");
            }
        </script>
