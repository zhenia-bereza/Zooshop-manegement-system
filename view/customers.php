    ...
    <div class="row align-items-center mt-3 mb-3">
            ...
            <div class="col-md-8 col-12 text-md-right text-center">
                <div class="nav-links mt-md-0 mt-3">
                    ...
                    <a href="admin.php?customers=true" class="active-link">Customers</a>
                ...
                <div class="modal-content">
                    ...
                    <form class="form" action="admin.php" method="POST">
                        <div class="modal-body">
                            ...
                            <input class="form-control" type="text" name="customer_initials"><br>

                            <label>Pet</label>
                            <input class="form-control" type="text" name="customer_pet"><br>

                            <label>Phone</label>
                            <input class="form-control" type="text" name="customer_phone"><br>
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <form class="form" action="admin.php" method="POST">
                        <div class="modal-body">
                            <label>Initials</label>
                            <input class="form-control" value="<?= $selected_row['customer_initials'] ?>" type="text" name="customer_initials"><br>

                            <label>Pet</label>
                            <input class="form-control" value="<?= $selected_row['customer_pet'] ?>" type="text" name="customer_pet"><br>

                            <label>Phone</label>
                            <input class="form-control" value="<?= $selected_row['customer_phone'] ?>" type="text" name="customer_phone"><br>
                ...
                <?php foreach ((array)$data as $d) : ?>
                    <tr>
                        <?php foreach ($d as $item) : ?>
                            <td><?= $item; ?></td>
                        <?php endforeach ?>
                        <td><a class="btn btn-warning" <?= $init_modal ?> href="admin.php?customers=true&action=edit&id=<?= $d['id'] ?>"><i class="fas fa-pen"></i></a></td>
                        <td><a class="btn btn-danger" href="admin.php?customers=true&action=delete&id=<?= $d['id'] ?>"><i class="fas fa-trash-alt"></i></a></td>
                    </tr>
                <?php endforeach ?>
            </table>
        </div>
        ...
        <script>
            function closeModal() {
                window.location.replace("/zoo/core/admin.php?customers=true");
            }
        </script>
